          ...
          <Grid container>
            <Grid item lg={2} md={4} sm={12} xs={12} className={classes.images}>
              <Box className={clsx(classes.ctaImg, classes.image1)}>
                <img
                  style={{ height: 'unset' }}
                  src={`${process.env.REACT_APP_DB_ROUTE}/img/logo-white.png`}
                  alt="logo"
                />
              </Box>
              <img
                src={`${process.env.REACT_APP_TOUR_IMG_ROUTE}/${images[1]}`}
                alt="photo1"
                className={clsx(classes.image2, classes.ctaImg)}
              />
              <img
                src={`${process.env.REACT_APP_TOUR_IMG_ROUTE}/${images[2]}`}
                alt="photo1"
